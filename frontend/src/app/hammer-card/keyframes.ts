...
export const rotateOutUpLeft = [
    style({ transform: 'rotate3d(0, 0, 0, 0deg)', opacity: 1, 'transform-origin': 'left bottom', offset: 0}),
    style({ transform: 'rotate3d(0, 0, 1, -45deg)', opacity: 0, 'transform-origin': 'left bottom', offset: 1}),
];
